...
<style> 
body{background:url(images/bbg.jpg)fixed;}</style>
<body>
	<form method="post">
    	<div id="is">
        	<div id="container">
...
$sql=mysql_query("select * from filmler where kategori_adi='Korku & Gerilim' limit $baslangic,$kacadet");
...
$sql=mysql_query("select * from filmler where kategori_adi='Korku & Gerilim'");

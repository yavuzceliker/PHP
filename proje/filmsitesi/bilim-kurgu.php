...
$sql=mysql_query("select * from filmler where kategori_adi='Bilim Kurgu' limit $baslangic,$kacadet ");
...
$sql=mysql_query("select * from filmler where kategori_adi='Bilim Kurgu'");
